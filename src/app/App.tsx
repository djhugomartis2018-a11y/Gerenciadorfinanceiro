          ...
          {data.months.map((m: string) => (
            ...
            >
              ...
              <button
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.parentElement!.querySelector('.del-btn')!.setAttribute('style', 'opacity: 1; font-size: 18px; color: var(--red); background: none; border: none; cursor: pointer;');
                }}
              >
                ×
              </button>
              ...
              <tr key={i} style={{ borderBottom: '1px solid var(--border)' }}>
                <td style={{ padding: 0 }}>
                  <input
                    ...
                    onFocus={(e) => (e.currentTarget.style.background = 'rgba(180, 245, 29, 0.05)')}
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '14px' }}>
              ...
              >
                ...
                <td style={{ padding: '14px 24px', textAlign: 'center' }}>
                  <input
                    type="checkbox"
                    checked={f.pago}
                    onChange={(e) => updateFixa(i, 'pago', e.target.checked)}
                    style={{
                      width: '18px',
                      height: '18px',
                      cursor: 'pointer',
          ...
          <tfoot>
            <tr style={{ background: 'rgba(255,255,255,0.03)' }}>
              ...
              <td colSpan={2} style={{ fontWeight: 700, padding: '16px 24px', color: 'var(--text)', textAlign: 'right' }}>
                {fmt(calc.fixas)}
              </td>
              <td></td>
              <td></td>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '14px' }}>
          ...
          <tfoot>
            <tr style={{ background: 'rgba(255,255,255,0.03)' }}>
              ...
              <td style={{ fontWeight: 700, padding: '16px 24px', color: 'var(--text)', textAlign: 'right' }}>
                {fmt(calc.variaveis)}
              </td>
              <td></td>
            </tr>
            <tr style={{ background: 'rgba(255,255,255,0.03)', borderTop: '2px solid var(--border-bright)' }}>
              ...
              <td style={{ fontWeight: 700, padding: '16px 24px', color: 'var(--red)', textAlign: 'right' }}>
                {fmt(calc.pagar)}
              </td>
              <td></td>
            </tr>
  ...
  return (
    <div>
      <div style={{ marginBottom: '32px' }}>
        ...
        <div style={{ fontSize: '14px', color: 'var(--text-dim)', marginTop: '4px' }}>
          Sua jornada econômica mês a mês
        </div>
      </div>
              ...
              >
                ...
                <td
                  style={{
                    ...
                    textAlign: 'right',
                    fontWeight: 700,
                    color: m.saldo >= 0 ? 'var(--text)' : 'var(--red)'
                  }}
                >
                  {fmt(m.saldo)}
                </td>
                <td style={{ padding: '16px 24px', textAlign: 'right' }}>
                  {m.rec ? ((m.saldo / m.rec) * 100).toFixed(1) + '%' : '—'}
                </td>
              </tr>
            ))}
          </tbody>
    ...
    <div>
      <div style={{ marginBottom: '32px', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
        <div>
          ...
          <div style={{ fontSize: '14px', color: 'var(--text-dim)', marginTop: '4px' }}>
            Transforme sobras em conquistas
          </div>
        </div>
        <button
          onClick={addMeta}
          ...
          data.metas.map((m, i) => {
            ...
            return (
              <div
                ...
                style={{
                  padding: '24px',
                  borderBottom: i < data.metas.length - 1 ? '1px solid var(--border)' : 'none'
                }}
              >
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '12px', fontWeight: 600 }}>
                  <span style={{ color: 'var(--text-dim)' }}>
                    Falta: {fmt(Math.max(0, n(m.total) - n(m.guardei)))}
                  </span>
